...
$ADMIN->add('reports', new admin_externalpage('teacherreport',
    get_string('pluginname', 'report_teacherreport'),
    $CFG->wwwroot.'/report/teacherreport/index.php', 'report/teacherreport:view'));
